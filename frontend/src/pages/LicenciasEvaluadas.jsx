...
// Mock con información y estado final
const mockDatabase = {
  "123": {
    student: {
    ...
    status: "Verificada",
    reason: "La documentación médica está completa y válida.",
  },
  "456": {
    student: {
    ...
    status: "Rechazada",
    reason: "El certificado médico no tiene firma válida.",
  },
  "789": {
    student: {
      name: "Ana Martínez",
    ...
    status: "Verificada",
    reason: "Licencia corta y bien respaldada.",
  },
};
...
export default function LicenciasEvaluadas() {
  ...
  const goBackToList = () => navigate("/evaluadas");
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 max-w-none">
          <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6 sm:p-8">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
              ...
              <button
                onClick={() => navigate("/licencia-info")}
            ...
            <section className="mb-6">
              <h2 className="text-lg font-semibold mb-3 text-gray-800">Resultado de Evaluación</h2>
              <div
                className={`p-4 rounded-lg border ${
                  license.status === "Verificada"
              ...
              >
                ...
                {license.reason && (
                  <p className="text-sm mt-2">Razón: {license.reason}</p>
                )}
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border mb-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  ...
                  <div>
                    <span className="font-medium text-gray-600">Inicio reposo:</span>{" "}
