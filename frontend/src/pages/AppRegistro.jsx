...
function AppRegistro() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-white items-center justify-start py-12">
      {/* Fondo */}
      <img
        src={bannerLogin}
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center">
        <div className="w-[90%] max-w-[50.25rem] bg-white rounded-lg shadow-md p-10">
