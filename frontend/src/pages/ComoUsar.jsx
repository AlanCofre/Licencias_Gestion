        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl overflow-hidden grid grid-cols-1 lg:grid-cols-3">
            <div className="lg:col-span-2 p-16 lg:p-20">
              ...
              <h2 className="text-lg lg:text-xl font-semibold mb-3">Primeros pasos:</h2>
              ...
              <ul className="list-disc pl-6 mb-8 text-gray-700 space-y-4 text-lg">
                <li>
            ...
            <div className="lg:col-span-1 flex items-center justify-center p-12 lg:p-16">
              <img
                src={signo}
