...
const BannerSection = () => {
  ...
  return (
    <section className="relative bg-gradient-to-r from-[var(--blue-600)] to-[var(--blue-400)] h-[300px] overflow-hidden">
      <div
        className="absolute inset-0 bg-cover bg-right opacity-70 pointer-events-none"
      ...
      <div className="relative z-10 h-full flex flex-col justify-between container mx-auto px-8">
        ...
        <div className="pb-12">
          <div className="flex flex-wrap gap-12 max-w-4xl items-center justify-center mx-auto">
