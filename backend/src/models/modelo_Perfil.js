...
const Perfil = sequelize.define('Perfil', {
  ...
  correo_alt:  { type: DataTypes.STRING(255), allowNull: true, validate: { isEmail: { msg: 'Correo alternativo inválido' } } },
  telefono:    { type: DataTypes.STRING(20),  allowNull: true, validate: { is: { args: [/^[+()\-\s\d]{6,20}$/], msg: 'Teléfono inválido' } } },
  ...
  timestamps: true,
  createdAt: 'creado_en',           // <-- mapea tus timestamps
