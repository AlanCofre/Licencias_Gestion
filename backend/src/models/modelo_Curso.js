...
Curso.init(
  {
    ...
    codigo: { type: DataTypes.STRING(20), allowNull: false, validate: { notEmpty: { msg: 'El código del curso no puede estar vacío' }, len: { args: [1, 20], msg: 'El código debe tener entre 1 y 20 caracteres' } } },
    nombre_curso: { type: DataTypes.STRING(100), allowNull: false, validate: { notEmpty: { msg: 'El nombre del curso no puede estar vacío' }, len: { args: [1, 100], msg: 'El nombre debe tener entre 1 y 100 caracteres' } } },
  ...
  { 
    ...
    tableName: 'curso', 
    timestamps: false,
    indexes: [ { unique: true, fields: ['codigo', 'seccion', 'periodo'], name: 'uq_curso_seccion_periodo' } ],
    hooks: {
